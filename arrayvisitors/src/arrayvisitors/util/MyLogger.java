...
public class MyLogger {
     ...
     * DebugValue = 4 (For COMMONINTSVISITOR class)
     * DebugValue = 5 (For MISSINGINTSVISITOR class) 
     * DebugValue = 6 (For POPULATEMYARRAYVISITOR class) 
     * DebugValue = 7 (For MYARRAY class) 
     * DebugValue = 8 (For MYARRAYLIST class) 
